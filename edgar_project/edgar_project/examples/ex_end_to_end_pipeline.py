...
# File I/o
# ------------------------------------------------------------------------------
folder_raw        = r'C:\temp\junk\e2e_example\10k_reports_raw'
folder_clean      = r'C:\temp\junk\e2e_example\10k_reports_clean'
sentiment_file    = r'C:\temp\junk\e2e_example\sentiment_factors.csv'
stockreturns_file = r'C:\temp\junk\e2e_example\stock_returns.csv'
...
import edgar.edgar_cleaner as edgar_cleaner
