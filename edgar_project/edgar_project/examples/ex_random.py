...
write_document_sentiments(folder_clean10k, r'C:\temp\junk\sentiment_factors.csv')
...
df.to_csv(r'C:\temp\junk\sentiment_factors.csv', index=False)
...
df_returns.to_csv(r'C:\temp\junk\stock_returns_daily.csv', index=False)
...
df_sentiment = pd.read_csv(r'C:\temp\junk\sentiment_factors.csv')

df_returns   = pd.read_csv(r'C:\temp\junk\stock_returns_daily.csv')
